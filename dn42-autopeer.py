...
def main():
    ...
    os.environ['DN42_WG_LINK_LOCAL_PREFIX'] = os.getenv('DN42_WG_LINK_LOCAL_PREFIX', 'fe80:0263::')
    os.environ['DN42_WG_LOCAL_ADDRESS'] = os.getenv('DN42_WG_LOCAL_ADDRESS', 'fe80::263')
