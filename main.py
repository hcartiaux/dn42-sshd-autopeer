...
if __name__ == '__main__':
    ...
    os.environ['SSH_MOTD_PATH']           = os.getenv('SSH_MOTD_PATH', 'motd')
    os.environ['DN42_REGISTRY_DIRECTORY'] = os.getenv('DN42_REGISTRY_DIRECTORY', '/home/hcartiaux/repos/perso/git.dn42.dev/dn42/registry/')
